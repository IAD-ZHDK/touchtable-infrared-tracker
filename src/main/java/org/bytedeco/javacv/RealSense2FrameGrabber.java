...
public class RealSense2FrameGrabber extends FrameGrabber {
    ...
    public void setOption(int optionIndex, boolean value) throws Exception {
        setOption(optionIndex, value ? 1f : 0f);
    }

    public void setOption(int optionIndex, float value) throws Exception {
        rs2_options options = new rs2_options(this.device);
        setRs2Option(options, optionIndex, value);
    }

    public float getOption(int optionIndex) throws Exception {
        rs2_options options = new rs2_options(this.device);
        return getRs2Option(options, optionIndex);
    }
    ...
    private float getRs2Option(rs2_options options, int optionIndex) throws Exception {
        boolean isSupported = toBoolean(rs2_supports_option(options, optionIndex, error));
        checkError(error);
        ...
        float value = rs2_get_option(options, optionIndex, error);
        checkError(error);
        return value;
    }
