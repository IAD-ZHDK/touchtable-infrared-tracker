...
data class Mat2(
    @Expose var x: Float2 = Float2(x = 1.0f),
    @Expose var y: Float2 = Float2(y = 1.0f)) {
...
data class Mat3(
    @Expose var x: Float3 = Float3(x = 1.0f),
    @Expose var y: Float3 = Float3(y = 1.0f),
    @Expose var z: Float3 = Float3(z = 1.0f)) {
...
data class Mat4(
    @Expose var x: Float4 = Float4(x = 1.0f),
    @Expose var y: Float4 = Float4(y = 1.0f),
    @Expose var z: Float4 = Float4(z = 1.0f),
    @Expose var w: Float4 = Float4(w = 1.0f)) {
