...
package ch.bildspur.model.math

import com.google.gson.annotations.Expose
import org.bytedeco.opencv.global.opencv_cudaarithm.sqr
...
data class Float2(@Expose var x: Float = 0.0f, @Expose var y: Float = 0.0f) {
...
data class Float3(@Expose var x: Float = 0.0f, @Expose var y: Float = 0.0f, @Expose var z: Float = 0.0f) {
    ...
    inline operator fun plus(v: Float3) =
        Float3(x + v.x, y + v.y, z + v.z)
    inline operator fun minus(v: Float3) =
        Float3(x - v.x, y - v.y, z - v.z)
    inline operator fun times(v: Float3) =
        Float3(x * v.x, y * v.y, z * v.z)
...
data class Float4(
    @Expose var x: Float = 0.0f,
    @Expose var y: Float = 0.0f,
    @Expose var z: Float = 0.0f,
    @Expose var w: Float = 0.0f) {
    ...
    inline operator fun plus(v: Float3) =
        Float4(x + v.x, y + v.y, z + v.z, w)
    inline operator fun minus(v: Float3) =
        Float4(x - v.x, y - v.y, z - v.z, w)
    inline operator fun times(v: Float3) =
        Float4(x * v.x, y * v.y, z * v.z, w)
    inline operator fun div(v: Float3) =
        Float4(x / v.x, y / v.y, z / v.z, w)

    inline operator fun plus(v: Float4) =
        Float4(x + v.x, y + v.y, z + v.z, w + v.w)
    inline operator fun minus(v: Float4) =
        Float4(x - v.x, y - v.y, z - v.z, w - v.w)
    inline operator fun times(v: Float4) =
        Float4(x * v.x, y * v.y, z * v.z, w * v.w)
    inline operator fun div(v: Float4) =
        Float4(x / v.x, y / v.y, z / v.z, w / v.w)
...
inline operator fun Float.minus(v: Float2) =
    Float2(this - v.x, this - v.y)
inline operator fun Float.times(v: Float2) =
    Float2(this * v.x, this * v.y)
...
inline fun distance(a: Float2, b: Float2) =
    length(a - b)
...
inline fun reflect(i: Float2, n: Float2) = i - 2.0f * dot(
    n,
    i
) * n
...
inline fun min(a: Float2, b: Float2) =
    Float2(min(a.x, b.x), min(a.y, b.y))
inline fun max(v: Float2) = max(v.x, v.y)
inline fun max(a: Float2, b: Float2) =
    Float2(max(a.x, b.x), max(a.y, b.y))
...
inline fun lessThan(a: Float2, b: Float2) =
    Bool2(a.x < b.x, a.y < b.y)
inline fun lessThanEqual(a: Float2, b: Float) = Bool2(a.x <= b, a.y <= b)
inline fun lessThanEqual(a: Float2, b: Float2) =
    Bool2(a.x <= b.x, a.y <= b.y)
inline fun greaterThan(a: Float2, b: Float) = Bool2(a.x > b, a.y > b)
inline fun greaterThan(a: Float2, b: Float2) =
    Bool2(a.x > b.y, a.y > b.y)
inline fun greaterThanEqual(a: Float2, b: Float) =
    Bool2(a.x >= b, a.y >= b)
inline fun greaterThanEqual(a: Float2, b: Float2) =
    Bool2(a.x >= b.x, a.y >= b.y)
inline fun equal(a: Float2, b: Float) = Bool2(a.x == b, a.y == b)
inline fun equal(a: Float2, b: Float2) =
    Bool2(a.x == b.x, a.y == b.y)
inline fun notEqual(a: Float2, b: Float) = Bool2(a.x != b, a.y != b)
inline fun notEqual(a: Float2, b: Float2) =
    Bool2(a.x != b.x, a.y != b.y)

inline infix fun Float2.lt(b: Float) = Bool2(x < b, y < b)
inline infix fun Float2.lt(b: Float2) =
    Bool2(x < b.x, y < b.y)
inline infix fun Float2.lte(b: Float) = Bool2(x <= b, y <= b)
inline infix fun Float2.lte(b: Float2) =
    Bool2(x <= b.x, y <= b.y)
inline infix fun Float2.gt(b: Float) = Bool2(x > b, y > b)
inline infix fun Float2.gt(b: Float2) =
    Bool2(x > b.x, y > b.y)
inline infix fun Float2.gte(b: Float) = Bool2(x >= b, y >= b)
inline infix fun Float2.gte(b: Float2) =
    Bool2(x >= b.x, y >= b.y)
inline infix fun Float2.eq(b: Float) = Bool2(x == b, y == b)
inline infix fun Float2.eq(b: Float2) =
    Bool2(x == b.x, y == b.y)
inline infix fun Float2.neq(b: Float) = Bool2(x != b, y != b)
inline infix fun Float2.neq(b: Float2) =
    Bool2(x != b.x, y != b.y)

inline fun any(v: Bool2) = v.x || v.y
inline fun all(v: Bool2) = v.x && v.y

inline operator fun Float.plus(v: Float3) =
    Float3(this + v.x, this + v.y, this + v.z)
inline operator fun Float.minus(v: Float3) =
    Float3(this - v.x, this - v.y, this - v.z)
inline operator fun Float.times(v: Float3) =
    Float3(this * v.x, this * v.y, this * v.z)
inline operator fun Float.div(v: Float3) =
    Float3(this / v.x, this / v.y, this / v.z)
...
inline fun distance(a: Float3, b: Float3) =
    length(a - b)
...
inline fun reflect(i: Float3, n: Float3) = i - 2.0f * dot(
    n,
    i
) * n
...
inline fun min(a: Float3, b: Float3) =
    Float3(min(a.x, b.x), min(a.y, b.y), min(a.z, b.z))
inline fun max(v: Float3) = max(v.x, max(v.y, v.z))
inline fun max(a: Float3, b: Float3) =
    Float3(max(a.x, b.x), max(a.y, b.y), max(a.z, b.z))

inline fun transform(v: Float3, block: (Float) -> Float) = v.copy().transform(block)

inline fun lessThan(a: Float3, b: Float) =
    Bool3(a.x < b, a.y < b, a.z < b)
inline fun lessThan(a: Float3, b: Float3) =
    Bool3(a.x < b.x, a.y < b.y, a.z < b.z)
inline fun lessThanEqual(a: Float3, b: Float) =
    Bool3(a.x <= b, a.y <= b, a.z <= b)
inline fun lessThanEqual(a: Float3, b: Float3) =
    Bool3(a.x <= b.x, a.y <= b.y, a.z <= b.z)
inline fun greaterThan(a: Float3, b: Float) =
    Bool3(a.x > b, a.y > b, a.z > b)
inline fun greaterThan(a: Float3, b: Float3) =
    Bool3(a.x > b.y, a.y > b.y, a.z > b.z)
inline fun greaterThanEqual(a: Float3, b: Float) =
    Bool3(a.x >= b, a.y >= b, a.z >= b)
inline fun greaterThanEqual(a: Float3, b: Float3) =
    Bool3(a.x >= b.x, a.y >= b.y, a.z >= b.z)
inline fun equal(a: Float3, b: Float) =
    Bool3(a.x == b, a.y == b, a.z == b)
inline fun equal(a: Float3, b: Float3) =
    Bool3(a.x == b.x, a.y == b.y, a.z == b.z)
inline fun notEqual(a: Float3, b: Float) =
    Bool3(a.x != b, a.y != b, a.z != b)
inline fun notEqual(a: Float3, b: Float3) =
    Bool3(a.x != b.x, a.y != b.y, a.z != b.z)

inline infix fun Float3.lt(b: Float) = Bool3(x < b, y < b, z < b)
inline infix fun Float3.lt(b: Float3) =
    Bool3(x < b.x, y < b.y, z < b.z)
inline infix fun Float3.lte(b: Float) = Bool3(x <= b, y <= b, z <= b)
inline infix fun Float3.lte(b: Float3) =
    Bool3(x <= b.x, y <= b.y, z <= b.z)
inline infix fun Float3.gt(b: Float) = Bool3(x > b, y > b, z > b)
inline infix fun Float3.gt(b: Float3) =
    Bool3(x > b.x, y > b.y, z > b.z)
inline infix fun Float3.gte(b: Float) = Bool3(x >= b, y >= b, z >= b)
inline infix fun Float3.gte(b: Float3) =
    Bool3(x >= b.x, y >= b.y, z >= b.z)
inline infix fun Float3.eq(b: Float) = Bool3(x == b, y == b, z == b)
inline infix fun Float3.eq(b: Float3) =
    Bool3(x == b.x, y == b.y, z == b.z)
inline infix fun Float3.neq(b: Float) = Bool3(x != b, y != b, z != b)
inline infix fun Float3.neq(b: Float3) =
    Bool3(x != b.x, y != b.y, z != b.z)

inline fun any(v: Bool3) = v.x || v.y || v.z
inline fun all(v: Bool3) = v.x && v.y && v.z

inline operator fun Float.plus(v: Float4) =
    Float4(this + v.x, this + v.y, this + v.z, this + v.w)
inline operator fun Float.minus(v: Float4) =
    Float4(this - v.x, this - v.y, this - v.z, this - v.w)
inline operator fun Float.times(v: Float4) =
    Float4(this * v.x, this * v.y, this * v.z, this * v.w)
inline operator fun Float.div(v: Float4) =
    Float4(this / v.x, this / v.y, this / v.z, this / v.w)
...
inline fun distance(a: Float4, b: Float4) =
    length(a - b)
...
inline fun lessThan(a: Float4, b: Float) =
    Bool4(a.x < b, a.y < b, a.z < b, a.w < b)
inline fun lessThan(a: Float4, b: Float4) =
    Bool4(a.x < b.x, a.y < b.y, a.z < b.z, a.w < b.w)
inline fun lessThanEqual(a: Float4, b: Float) =
    Bool4(a.x <= b, a.y <= b, a.z <= b, a.w <= b)
inline fun lessThanEqual(a: Float4, b: Float4) =
    Bool4(a.x <= b.x, a.y <= b.y, a.z <= b.z, a.w <= b.w)
inline fun greaterThan(a: Float4, b: Float) =
    Bool4(a.x > b, a.y > b, a.z > b, a.w > b)
inline fun greaterThan(a: Float4, b: Float4) =
    Bool4(a.x > b.y, a.y > b.y, a.z > b.z, a.w > b.w)
inline fun greaterThanEqual(a: Float4, b: Float) =
    Bool4(a.x >= b, a.y >= b, a.z >= b, a.w >= b)
inline fun greaterThanEqual(a: Float4, b: Float4) =
    Bool4(a.x >= b.x, a.y >= b.y, a.z >= b.z, a.w >= b.w)
inline fun equal(a: Float4, b: Float) =
    Bool4(a.x == b, a.y == b, a.z == b, a.w == b)
inline fun equal(a: Float4, b: Float4) =
    Bool4(a.x == b.x, a.y == b.y, a.z == b.z, a.w == b.w)
inline fun notEqual(a: Float4, b: Float) =
    Bool4(a.x != b, a.y != b, a.z != b, a.w != b)
inline fun notEqual(a: Float4, b: Float4) =
    Bool4(a.x != b.x, a.y != b.y, a.z != b.z, a.w != b.w)

inline infix fun Float4.lt(b: Float) = Bool4(x < b, y < b, z < b, a < b)
inline infix fun Float4.lt(b: Float4) =
    Bool4(x < b.x, y < b.y, z < b.z, w < b.w)
inline infix fun Float4.lte(b: Float) =
    Bool4(x <= b, y <= b, z <= b, w <= b)
inline infix fun Float4.lte(b: Float4) =
    Bool4(x <= b.x, y <= b.y, z <= b.z, w <= b.w)
inline infix fun Float4.gt(b: Float) = Bool4(x > b, y > b, z > b, w > b)
inline infix fun Float4.gt(b: Float4) =
    Bool4(x > b.x, y > b.y, z > b.z, w > b.w)
inline infix fun Float4.gte(b: Float) =
    Bool4(x >= b, y >= b, z >= b, w >= b)
inline infix fun Float4.gte(b: Float4) =
    Bool4(x >= b.x, y >= b.y, z >= b.z, w >= b.w)
inline infix fun Float4.eq(b: Float) =
    Bool4(x == b, y == b, z == b, w == b)
inline infix fun Float4.eq(b: Float4) =
    Bool4(x == b.x, y == b.y, z == b.z, w == b.w)
inline infix fun Float4.neq(b: Float) =
    Bool4(x != b, y != b, z != b, w != b)
inline infix fun Float4.neq(b: Float4) =
    Bool4(x != b.x, y != b.y, z != b.z, w != b.w)

inline fun any(v: Bool4) = v.x || v.y || v.z || v.w
inline fun all(v: Bool4) = v.x && v.y && v.z && v.w

data class Bool2(@Expose var x: Boolean = false, @Expose var y: Boolean = false) {
...
data class Bool3(@Expose var x: Boolean = false, @Expose var y: Boolean = false, @Expose var z: Boolean = false) {
...
data class Bool4(
    @Expose var x: Boolean = false,
    @Expose var y: Boolean = false,
    @Expose var z: Boolean = false,
    @Expose var w: Boolean = false) {
